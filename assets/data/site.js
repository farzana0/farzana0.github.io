...
window.SITE = {
  ...
  bio: [
    ...
    "A common thread runs through my work: <strong>multilinear structure</strong>. Many objects we care about — feature attributions, cooperative-game values, learned representations, quantum circuits — are secretly multilinear, and <strong>tensor networks</strong> give a compact, tractable handle on them. I use this to compute Shapley values and higher-order interactions efficiently, to probe and steer language-model representations, and to audit how models behave when they know they are being evaluated.",
